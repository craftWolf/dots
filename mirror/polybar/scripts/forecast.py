...
def map_icon(code: str) -> str:
    ...
    if code == '01d' or code == '01n': return u'☀️'
    if code == '02d' or code == '02n': return u'🌥'
    if code == '03d' or code == '03n': return u'☁️'
    if code == '04d' or code == '04n': return u'☁️'
    if code == '09d' or code == '09n': return u'🌧'
    if code == '10d' or code == '10n': return u'🌧'
    if code == '11d' or code == '11n': return u'🌩'
    if code == '12d' or code == '12n': return u'🌨'
