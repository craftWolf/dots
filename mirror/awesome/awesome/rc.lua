...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- everything else should be tile or floating
    local layouts = { l.tile, l.tile, l.tile, l.max.fullscreen, l.tile, 
...
-- Disable minimization since there is no way to manually unminimize windows
-- and games like CS:GO minimize when we switch workspace other wise
-- Also this is dumb and makes no sense when used without a task list
client.connect_signal("property::minimized", function(c)
    c.minimized = false
end)

-- Only show the titlebar for floating windows
